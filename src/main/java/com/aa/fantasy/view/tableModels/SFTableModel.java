...
public class SFTableModel extends AbstractTableModel implements PropertyChangeListener {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		FantasyApp.log.debug("SFTableModel is aware that a property has changed");
		if(evt.getPropertyName().equals("SFsPlaying")){
