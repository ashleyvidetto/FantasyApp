...
public class SGTableModel extends AbstractTableModel implements PropertyChangeListener {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		FantasyApp.log.debug("SGTableModel is aware that a property has changed");
		if(evt.getPropertyName().equals("SGsPlaying")){
