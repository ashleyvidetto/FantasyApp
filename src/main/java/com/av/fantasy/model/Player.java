...
public class Player {
	...
	private String team;
	private int Salary; //The salary amount the player costs this week
	private String notes; //Notes about the player
	/*
	 ...
	 */
	public Player(double averagePoints, double averageRebounds, double averageAssists, double averageBlocks, double averageSteals, double averageTurnovers, int Salary, int Type){
	 ...
	 * @param Type - the eligible position of the player (1-5)
	 */
	public Player(String name, double averagePoints, double averageRebounds, double averageAssists, double averageBlocks, double averageSteals, double averageTurnovers, int Type, String Team){
		this.name = name;
		this.averagePoints = averagePoints;
		this.averageRebounds = averageRebounds;
		this.averageAssists = averageAssists;
